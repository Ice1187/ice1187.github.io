...
![](https://ice1187.github.io/assets/images/dosbox-x-mount.png)

1. 輸入 `debugbox <target_com_file> <args>` 便會開啟 DOSBox-X debugger，開始 debug 該 COM file。

```
C:> debugbox POLYGLOT.COM
```

![](https://ice1187.github.io/assets/images/dosbox-x-debugger.png)

1. 剩下就是一般 debug 操作，一些常用指令如下，更多指令可以參考 [dosbox-x/README.debugger](https://github.com/joncampbell123/dosbox-x/blob/master/README.debugger)：
   | Command | Description |
   | --- | --- |
   | `f5` | Run |
   | `f10` | Step over |
...
![](https://ice1187.github.io/assets/images/dosbox-x-debug.png)
